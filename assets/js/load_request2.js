        ...
        if (parseInt(val.fields.new_request, 10) == 1){
            req_class = 'info';
                ...
                items.push('<tr class="' + req_class + '" id="'+ val.pk +'">'
                    ...
                    + '<td class="td_click plus" style = "cursor: pointer;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></td>'
                    + '<td class="td_click" style = "cursor: pointer;"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></td>'
                    + '</tr>'
        );
